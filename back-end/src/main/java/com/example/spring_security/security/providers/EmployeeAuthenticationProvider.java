...
public class EmployeeAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (userDetails != null) {
            if (passwordEncoder.matches(password,userDetails.getPassword())) {
                ...
                return new EmployeeAuthentication(userDetails.getCode(),null,userDetails.getAuthorities(),userDetails.getFullName());
            }
        }
    ...
    public boolean supports(Class<?> authentication) {
        return EmployeeAuthentication.class.equals(authentication);
    }
}
